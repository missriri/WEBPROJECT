<html>
    ...
    <body>
        ...
        <div class="container-one" id="bgpic">
            <div class="container">
                <h1 class="Headings font-4">WHO DO YOU WANT TO REGISTER YOURSELF AS?</h1>
                
                <ul id="logsign">
                    <li><a href="JUNKTIONSIGNUP.php" title="Takes you to our register page for users"class="logsignlinks">REGISTER AS A CUSTOMER</a></li>
                    <li><a href="ADMINPASSWORDVERIFY.php" title="Takes you to our admin register page"class="logsignlinks">REGISTER AS AN ADMIN</a></li>
                </ul>             
            </div>    
       </div>
