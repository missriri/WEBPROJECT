...

{
    ...
    $sql_update = "UPDATE `admin_table` SET `Firstname`= '$fname', `Middlename` = '$mname', `Lastname` = '$lname', `Email` = '$email',`username`='$username',`userpassword` = '$password',`Userpasswordconfirm` = '$password',`Dateofbirth` = '$date',`Phonenumber` = '$phone' WHERE `record_id` = '$record' ";
