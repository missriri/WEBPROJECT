...
<html>
    <head>
        <meta charset="utf-8">
        <title>JUNKTION Admin sign up</title>
    ...
    <body>
        ...
        <div class="container-one" id="bgpic4">
            <div class="container">
                ...
                <div class="form-cont">
                <p style="text-align:center;"><?php echo "You can now register as an admin";?></p>
                <form method="post" action="PROCESS_JUNKTIONSIGNUP2.php">
